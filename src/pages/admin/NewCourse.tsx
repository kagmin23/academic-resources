import {
  ...
  import { Button, Col, Input, Layout, Row, Switch, Table, Typography ,Modal } from 'antd';
  ...
  const initialDataSource: DataType[] = [
    {
      ...
      title: 'Item 1',
      status: false,
      description: 'Description for Item 1, Description for Item 1,Description for Item 1 ,Description for Item 1 ,Description for Item 1,Description for Item 1,Description for Item 1 ',
      price: 100,
      created_at: '2024-01-01',
      instructor: 'Instructor 1 ',
      category:'English, Marth, History',
      lesson: 10
    },
    {
      key: '2',
                    ...
                    <div style={{ padding: '10px 20px', backgroundColor: '#f9f9f9', borderRadius: '4px', marginLeft: '25px' }}>
                     ...
                     <div className='w-20 h-0.5 bg-blue-700 mb-7'></div> 
                      ...
                      <Row gutter={16} align="middle" style={{ display: 'flex', justifyContent: 'space-between', marginTop:'20px' }}> 
                        ...
                        <Col span={5} style={{ }}>
                          <Text strong>Number of Lesson:</Text>
                          <p className='center'>{record.lesson} lessons</p>

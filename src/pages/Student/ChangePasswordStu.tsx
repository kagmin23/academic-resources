                ...
                <div className="mt-4">
                    <section className="mb-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <InfoItem label="Ảnh đại diện" value={<img className="w-16 h-16 rounded-full" src="https://files.fullstack.edu.vn/f8-prod/user_photos/379503/65826d8841a16.jpg" alt="avatar" />} />
                        </div>
                    </section>
                    <section>
                        <div className="mb-4">
    ...
    return (
        <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Button className="text-gray-500">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-right" className="w-5 h-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">

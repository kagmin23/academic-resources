...
//     const lessons = dataSource.filter(item => item.name.toLowerCase().includes(value.toLowerCase()));
//     setLessons(lessons);
//   };
...
const ManagerLessonInstructor: React.FC = () => {
  ...
  const handleSearch = (value: string) => {
    const filteredLessons = dataSource.filter(item => item.name.toLowerCase().includes(value.toLowerCase()));
